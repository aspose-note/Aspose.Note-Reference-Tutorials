...
- **Какая версия Java требуется?** Java 8 или новая версия (пример использует JDK 8).
...
Убедитесь, что в вашей системе установлен Java Development Kit (JDK). Вы можете скачать его [здесь](https://www.oracle.com/java/technologies/downloads/), если ещё не сделали этого.
