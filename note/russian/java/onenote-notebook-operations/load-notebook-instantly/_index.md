...
1. **Java Development Kit (JDK):** Убедитесь, что Java установлена в вашей системе. Вы можете скачать и установить последнюю JDK по [этой ссылке](https://www.oracle.com/java/technologies/downloads/).
...
**Тестировано с:** Aspose.Note для Java 26.4 (latest)  
**Автор:** Aspose  
