...
1. **Java Development Kit (JDK)** – Säkerställ att JDK är installerat. Du kan ladda ner det från [Oracle‑webbplatsen](https://www.oracle.com/java/technologies/downloads/).  
...
**Testat med:** Aspose.Note 26.4 för Java  
**Författare:** Aspose  
