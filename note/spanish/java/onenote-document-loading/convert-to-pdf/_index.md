...
- **¿Qué versión de Java es compatible?** JDK 8 o posterior (se recomienda JDK 8)  
...
1. **Java Development Kit (JDK)** – JDK 8+ instalado. Puede descargarlo desde [aquí](https://www.oracle.com/java/technologies/downloads/).  
