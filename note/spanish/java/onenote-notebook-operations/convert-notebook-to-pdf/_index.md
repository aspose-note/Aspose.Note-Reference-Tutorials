...
1. **Java Development Kit (JDK)** – Asegúrese de que el JDK esté instalado. Puede descargarlo desde el [sitio web de Oracle](https://www.oracle.com/java/technologies/downloads/).  
