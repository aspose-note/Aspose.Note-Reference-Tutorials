...
- **Mely Java verzió támogatott?** JDK 8 vagy újabb (JDK 8 ajánlott)  
...
1. **Java Development Kit (JDK)** – JDK 8+ telepítve. Letöltheti [innen](https://www.oracle.com/java/technologies/downloads/).  
