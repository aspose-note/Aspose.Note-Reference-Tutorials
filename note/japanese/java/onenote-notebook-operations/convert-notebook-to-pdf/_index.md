...
- **サポートされている Java バージョンは？** JDK 8 以降 (例では JDK 8 を使用)。  
...
1. **Java Development Kit (JDK)** – JDK がインストールされていることを確認してください。[Oracle website](https://www.oracle.com/java/technologies/downloads/) からダウンロードできます。  
