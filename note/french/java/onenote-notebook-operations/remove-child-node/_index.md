...
1. **Java Development Kit (JDK)** – Vérifiez que Java est installé sur votre système. Vous pouvez télécharger et installer le dernier JDK depuis [ici](https://www.oracle.com/java/technologies/downloads/).
