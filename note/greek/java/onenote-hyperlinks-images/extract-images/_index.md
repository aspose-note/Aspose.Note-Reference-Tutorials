...
- **Ποιες εκδόσεις της Java υποστηρίζονται;** Java 8 και νεότερες (συμπεριλαμβανομένης της Java 8).  
...
1. **Java Development Kit (JDK)** – Βεβαιωθείτε ότι έχετε εγκατεστημένη τη Java στο σύστημά σας. Μπορείτε να την κατεβάσετε και να την εγκαταστήσετε από το [website](https://www.oracle.com/java/technologies/downloads/).
