...
Α: Η βιβλιοθήκη λειτουργεί με Java SE 7 και νεότερες, συμπεριλαμβανομένων των Java 8, 11 και νεότερων LTS εκδόσεων.
...
**Δοκιμή Με:** Aspose.Note for Java 26.4 (τελευταία έκδοση τη στιγμή της συγγραφής)  
**Συγγραφέας:** Aspose  
