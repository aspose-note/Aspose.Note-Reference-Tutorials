...
- **지원되는 Java 버전은?** JDK 8 이상이면 모두 사용 가능 (예제는 JDK 8 사용).  
...
1. **Java Development Kit (JDK)** – JDK가 설치되어 있는지 확인하세요. [Oracle 웹사이트](https://www.oracle.com/java/technologies/downloads/)에서 다운로드할 수 있습니다.  
