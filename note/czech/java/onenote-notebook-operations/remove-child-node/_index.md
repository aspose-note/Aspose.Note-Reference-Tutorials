...
1. **Java Development Kit (JDK)** – používá se, že máte na svém systému nainstalovanou Javu. Nejnovější JDK si můžete stáhnout a nainstalovat z [zde](https://www.oracle.com/java/technologies/downloads/).
...
**Testováno s:** Aspose.Note 26.4 pro Javu
**Autor:** Aspose  
