...
- **เวอร์ชัน Java ใดที่รองรับ?** Java 8 และใหม่กว่า (รวมถึง Java 8).  
...
1. **Java Development Kit (JDK)** – ตรวจสอบว่าคุณได้ติดตั้ง Java บนระบบของคุณแล้ว คุณสามารถดาวน์โหลดและติดตั้งได้จาก [website](https://www.oracle.com/java/technologies/downloads/).
