...
1. **Bộ công cụ phát triển Java (JDK)** – Đảm bảo bạn đã cài đặt Java trên hệ thống. Bạn có thể tải và cài đặt JDK mới nhất từ ​​[tại đây](https://www.oracle.com/java/technologies/downloads/).
...
**Đã thử nghiệm với:** Aspose.Note 26.4 cho Java
**Tác giả:** Giả định  
