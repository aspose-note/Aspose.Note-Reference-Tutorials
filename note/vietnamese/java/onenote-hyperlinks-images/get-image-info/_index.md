...
Đảm bảo bạn đã cài đặt Java Development Kit (JDK) trên hệ thống của mình. Bạn có thể tải và cài đặt JDK mới nhất từ [Oracle website](https://www.oracle.com/java/technologies/downloads/).
