...
1. **Java Development Kit (JDK):** Certifique‑se de que o Java está instalado em seu sistema. Você pode baixar e instalar o JDK mais recente a partir de [here](https://www.oracle.com/java/technologies/downloads/).
