...
- **Qual versão do Java é suportada?** JDK 8 ou superior (JDK 8 é recomendado)  
...
1. **Java Development Kit (JDK)** – JDK 8+ instalado. Você pode baixá‑lo [aqui](https://www.oracle.com/java/technologies/downloads/).  
