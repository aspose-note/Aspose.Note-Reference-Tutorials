...
- **Quale versione di Java è supportata?** JDK 8 o successive (JDK 8 è consigliato)  
...
1. **Java Development Kit (JDK)** – JDK 8+ installato. Puoi scaricarlo da [qui](https://www.oracle.com/java/technologies/downloads/).  
